...
export default User = class User {
  constructor(name = '', email = '', phone = '', children = [], coparents = [], parentType = '', accountType = '', allowNotifications = '', id = Manager.getUid(), defaultTransferLocation = '', defaultTransferNavLink = '', dailySummaries = {
      morningSentDate: '',
      eveningSentDate: '',
