...
export default User = class User {
  constructor(name = '', email = '', phone = '', children = [], coparents = [], parentType = '', accountType = '', allowNotifications = '', id = Manager.getUid(), defaultTransferLocation = '', defaultTransferNavLink = '', settings = {
      theme: 'light'
    }, dailySummaries = {
      morningSentDate: '',
      eveningSentDate: '',
