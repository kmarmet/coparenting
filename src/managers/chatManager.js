...
ChatManager = {
      CreateAndInsertChat: async function (sender, recipient) {
            ...
            existingChats = await DB.GetTableData(`${DB.tables.chats}/${sender != null ? sender.key : void 0}`)
      ...
      GetToneAndSentiment: async function (message) {
            ...
            returnSentiment =
                  sentiment != null ? ((ref3 = sentiment.overall) != null ? ((ref4 = ref3[0]) != null ? ref4[1] : void 0) : void 0) : void 0
      ...
      ResumeChat: async function (currentUser, coParentKey, chat) {
            ...
            try {
                  isPausedFor =
                        chat != null
                              ? (ref1 = chat.isPausedFor) != null
                                    ? ref1.filter(function (x) {
                                            return x !== (currentUser != null ? currentUser.key : void 0)
                                      })
                                    : void 0
                              : void 0
