...
export default SmsManager = {
  ...
  getParentVerificationTemplate: function (childName, verificationCode) {
    return `${uppercaseFirstLetterOfAllWords(childName)} is registering for an account and requires your permission for access. ${SmsManager.lineBreak}${SmsManager.lineBreak}If you accept, please share this code with them: ${verificationCode} ${SmsManager.lineBreak}${SmsManager.signature}`
  },
