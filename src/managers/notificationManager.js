      ...
      return setTimeout(function () {
        ...
        return fetch(`https://api.onesignal.com/apps/${NotificationManager.appId}/subscriptions/${subId}/user/identity`).then(
          async function (identity) {
            ...
            existingSubscriber = await DB.find(
              DB.tables.notificationSubscribers,
              ['email', NotificationManager != null ? ((ref4 = NotificationManager.currentUser) != null ? ref4.email : void 0) : void 0],
              true
            )
