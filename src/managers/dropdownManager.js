      ...
      GetDefault: {
            ...
            ShareWith: function (children, coParents) {
                  ...
                  options = merged.map(function (x) {
                        ...
                        return {
                              label:
                                    (ref1 = StringManager.GetFirstNameOnly(x != null ? ((ref2 = x.general) != null ? ref2.name : void 0) : void 0)) !=
                                    null
                                          ? ref1
                  ...
                  if (Manager.IsValid(users)) {
                        for (i = 0, len = users.length; i < len; i++) {
                              ...
                              options.push({
                                    ...
                                    label:
                                          StringManager != null
                                                ? StringManager.UppercaseFirstLetterOfAllWords(user != null ? user.name : void 0)
                                                : void 0,
                              })
                        }
                  }
