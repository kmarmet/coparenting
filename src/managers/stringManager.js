...
StringManager = {
    ...
    GetFirstNameAndLastInitial: function (fullName) {
        ...
        if (Manager.IsValid(fullName, true)) {
            ...
            firstName = names[0]
            lastNameInitial =
                (names != null ? names.length : void 0) > 1
                    ? names != null
                        ? (ref = names[(names != null ? names.length : void 0) - 1]) != null
                            ? ref[0]
                            : void 0
                        : void 0
                    : ""
    ...
    FormatPhone: function (input) {
        ...
        input =
            input != null
                ? input.toString().replace(/-/g, "").replace(/\s+/g, "").replace(/\(/g, "").replace(/\)/g, "").replace(/\+/g, "").replace(/\+1/g, "")
                : void 0
        return input
    },
    ...
    SpaceBetweenWords: function (input) {
        var ref
        if (!Manager.IsValid(input, true) || (input != null ? input.length : void 0) === 0) {
            return input
        }
        return input != null ? ((ref = input.toString()) != null ? ref.replace(/([a-z])([A-Z])/g, "$1 $2") : void 0) : void 0
    },
    ...
    GetFileExtension: function (fileName) {
        var ref
        if (!Manager.IsValid(fileName, true) || (fileName != null ? fileName.length : void 0) === 0) {
            return ""
        }
        return fileName != null ? ((ref = fileName.split(".")) != null ? ref.pop() : void 0) : void 0
    },
