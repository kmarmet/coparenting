...
const DocumentConversionManager = {
      ...
      DocToHtml: async (fileName, url, currentUserKey) => {
            try {
                  ...
                  console.log("To Send: ", `${apiAddress}/document/getDocText?fileName=${fileName}&docUrl=${url}&currentUserId=${currentUserKey}`)
                  const response = await fetch(
                        `${apiAddress}/document/getDocText?fileName=${fileName}&docUrl=${url}&currentUserId=${currentUserKey}`,
                        requestOptions
                  )
