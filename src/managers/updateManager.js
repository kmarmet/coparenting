...
export default UpdateManager = {
    ...
    templates: {
        ...
        handoffChangeRequestApproval: function (request, recipientName) {
            return `Handoffs Change Request for ${moment(request != null ? request.startDate : void 0).format(DateFormats.readableMonthAndDay)} has been APPROVED by ${recipientName}${UpdateManager.lineBreak}${UpdateManager.lineBreak}`
        },
        handoffChangeRequestRejection: function (request, recipientName) {
            return `Handoffs Change Request for ${moment(request != null ? request.startDate : void 0).format(DateFormats.readableMonthAndDay)} has been DECLINED.${UpdateManager.lineBreak}${UpdateManager.lineBreak} Reason: ${request.declineReason}. If you would still prefer to proceed with the request, please contact ${recipientName} to negotiate a potential agreement`
        },
    },
    //  PRODUCTION
        ...
        try {
            if (userSubscribed && subId) {
                ...
                return setTimeout(function () {
                    ...
                    return fetch(`https://api.onesignal.com/apps/${UpdateManager.appId}/subscriptions/${subId}/user/identity`).then(
                        async function (identity) {
                            var currentSubscribers, existingSubscriber, existingSubscriberIndex, ref3, userIdentity
                            userIdentity = await identity.json()
                            newSubscriber.oneSignalId =
                                userIdentity != null ? ((ref3 = userIdentity.identity) != null ? ref3.onesignal_id : void 0) : void 0
                            ...
                            if (Manager.IsValid(currentSubscribers)) {
                                existingSubscriber =
                                    currentSubscribers != null
                                        ? currentSubscribers.find(function (x) {
                                              var ref4
                                              return (
                                                  (x != null ? x.email : void 0) ===
                                                  (UpdateManager != null
                                                      ? (ref4 = UpdateManager.currentUser) != null
                                                          ? ref4.email
                                                          : void 0
                                                      : void 0)
                                              )
                                        ...
                                        : void 0
                                existingSubscriberIndex = DB.GetIndexById(
                                    currentSubscribers,
                                    existingSubscriber != null ? existingSubscriber.id : void 0
                                )
                                ...
                                if (!existingSubscriber) {
                                    ...
                                    if (existingSubscriberIndex && existingSubscriberIndex > -1) {
                                        return await DB.updateEntireRecord(
                                            `${DB.tables.updateSubscribers}/${existingSubscriberIndex}`,
                                            existingSubscriber,
    ...
    SendUpdate: async function (title, message, recipientKey, currentUser = null, category = "") {
        var allSubs, newNotification, raw, ref, subId, subIdRecord
        ...
        if (currentUser != null ? ((ref = currentUser.mutedUserKeys) != null ? ref.includes(recipientKey) : void 0) : void 0) {
            return false
        }
        ...
        newNotification.owner = {
            ...
            phone: currentUser != null ? currentUser.phone : void 0,
        }
