...
if (typeof userIdentity !== "undefined" && userIdentity !== null) {
  if ((ref = userIdentity.identity) != null) {
    ref.onesignal_id = void 0;
  }
}
...
export default UpdateManager = {
  ...
  eventListener: function(event) {
    var error, newSubscriber, ref1, subId, userSubscribed;
    userSubscribed = OneSignal.User.PushSubscription.optedIn;
    subId = event != null ? (ref1 = event.current) != null ? ref1.id : void 0 : void 0;
    try {
      if (userSubscribed && subId) {
        newSubscriber = new UpdateSubscriber();
        return setTimeout(function() {
          var ref2, ref3;
          newSubscriber.email = UpdateManager != null ? (ref2 = UpdateManager.currentUser) != null ? ref2.email : void 0 : void 0;
          newSubscriber.key = UpdateManager != null ? (ref3 = UpdateManager.currentUser) != null ? ref3.key : void 0 : void 0;
          ...
          return fetch(`https://api.onesignal.com/apps/${UpdateManager.appId}/subscriptions/${subId}/user/identity`).then(async function(identity) {
            var currentUpdates, existingSubscriber, index, ref4, ref5, userIdentity;
            ...
            if (Manager.IsValid(existingSubscriber)) {
              existingSubscriber = currentUpdates.find((x) => {
                var ref5;
                return (x != null ? x.email : void 0) === (UpdateManager != null ? (ref5 = UpdateManager.currentUser) != null ? ref5.email : void 0 : void 0);
              });
              existingSubscriber.subscriptionId = subId;
              existingSubscriber.oneSignalId = userIdentity != null ? (ref5 = userIdentity.identity) != null ? ref5.onesignal_id : void 0 : void 0;
