...
SecurityManager = {
            ...
            for (i = 0, len = linkedAccountKeys.length; i < len; i++) {
                ...
                for (j = 0, len1 = userAccountItems.length; j < len1; j++) {
                    ...
                    if (Manager.IsValid(item != null ? item.shareWith : void 0)) {
                        if (
                            item != null
                                ? (ref = item.shareWith) != null
                                    ? ref.includes(currentUser != null ? currentUser.key : void 0)
                                    : void 0
                                : void 0
                        ) {
            ...
            for (i = 0, len = ref.length; i < len; i++) {
                ...
                for (j = 0, len1 = coparentItems.length; j < len1; j++) {
                    ...
                    if (Manager.IsValid(item != null ? item.shareWith : void 0)) {
                        if (
                            item != null
                                ? (ref1 = item.shareWith) != null
                                    ? ref1.includes(currentUser != null ? currentUser.key : void 0)
                                    : void 0
                                : void 0
                        ) {
                            sharedItems.push(item)
            ...
            for (k = 0, len2 = ref2.length; k < len2; k++) {
                ...
                for (l = 0, len3 = parentItems.length; l < len3; l++) {
                    ...
                    if (Manager.IsValid(item != null ? item.shareWith : void 0)) {
                        if (
                            item != null
                                ? (ref3 = item.shareWith) != null
                                    ? ref3.includes(currentUser != null ? currentUser.key : void 0)
                                    : void 0
                                : void 0
                        ) {
                            sharedItems.push(item)
            ...
            for (m = 0, len4 = ref4.length; m < len4; m++) {
                ...
                for (n = 0, len5 = childItems.length; n < len5; n++) {
                    ...
                    if (Manager.IsValid(item != null ? item.shareWith : void 0)) {
                        if (
                            item != null
                                ? (ref5 = item.shareWith) != null
                                    ? ref5.includes(currentUser != null ? currentUser.key : void 0)
                                    : void 0
                                : void 0
                        ) {
                            sharedItems.push(item)
    ...
    GetUserVisitationHolidays: async function (currentUser) {
        var allEvents, filteredEvents, sharedEvents
        if (!(currentUser != null ? currentUser.key : void 0)) {
            return []
        }
        allEvents = []
        sharedEvents = []
        ...
        if (Manager.IsValid(allEvents)) {
            filteredEvents = allEvents.filter(function (event) {
                return (
                    Manager.IsValid(event != null ? event.startDate : void 0) &&
                    (event != null ? event.ownerKey : void 0) === currentUser.key &&
                    (event != null ? event.isHoliday : void 0) === true
                )
            })
        } else {
            return []
    ...
    getMemories: async function (currentUser) {
        ...
        returnRecords = []
        allMemories = DatasetManager.GetValidArray(await DB.GetTableData(`${DB.tables.memories}/${currentUser != null ? currentUser.key : void 0}`))
