                                    ...
                                    <InputField
                                          ...
                                          onDateOrTimeSelection={(dateArray) => {
                                                if (Manager.IsValid(dateArray)) {
                                                      ...
                                                      formRef.current.endDate = moment(dateArray[dateArray.length - 1]).format(
                              ...
                              <div>
                                    <div className="flex">
                                          ...
                                          <ToggleButton
                                                ...
                                                onCheck={() => setIsVisitation(true)}
                                                onUncheck={() => setIsVisitation(false)}
                                          />
                                    </div>
                              </div>
                              ...
                              {view?.label === "Single Day" && (
                                    <>
                                          <div className="flex">
                                                ...
                                                <ToggleButton
                                                      onCheck={() => setEventIsRecurring(true)}
                                                      onUncheck={() => setEventIsRecurring(false)}
                                                />
                                          </div>
                                          {eventIsRecurring && (
                                                <>
