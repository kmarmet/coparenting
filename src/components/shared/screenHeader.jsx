...
export default function ScreenHeader({title, screenDescription = '', children, wrapperClass = '', titleIcon = null}) {
    ...
    return (
        <div className={`screen-header ${theme} ${wrapperClass}`}>
            ...
            {/*        fill="#3c4cff"*/}
            {/*        fillOpacity="1"*/}
            {/*        d="M0,128L48,128C96,128,192,128,288,154.7C384,181,480,235,576,240C672,245,768,203,864,197.3C960,192,1056,224,1152,229.3C1248,235,1344,213,1392,202.7L1440,192L1440,0L1392,0C1344,0,1248,0,1152,0C1056,0,960,0,864,0C768,0,672,0,576,0C480,0,384,0,288,0C192,0,96,0,48,0L0,0Z"></path>*/}
            {/*</svg>*/}
        </div>
    )
}