  ...
  return (
    <>
      <div id="records-wrapper" className={`${theme} form page-container`}>
        <p className="screen-title">The Vault</p>
        <p className="screen-intro-text mb-15">
          Inside the vault&#39;s storage you can access and export data generated by you or your co-parent. This information can be utilized for
          personal reference, legal proceedings, or any other purpose you may require.
        </p>
        <p className="screen-intro-text mb-15">
