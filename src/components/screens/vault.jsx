...
export default function Vault() {
    ...
    const HandleSortBySelection = (e) => {
        ...
        if (label === expenseTypes.nearestDueDate) {
            const sortedByDateDesc = DatasetManager.SortExpenses(expenses, "string", "desc")
            setSortedExpenses(sortedByDateDesc)
        }

        // Date: Old -> New
        if (label === expenseTypes.oldestCreationDate) {
            ...
            <div id="records-wrapper" className={`${theme} page-container`}>
                ...
                <div className="screen-content">
                    ...
                    <SelectDropdown
                        ...
                        options={DropdownManager.GetDefault.VaultRecordTypes()}
