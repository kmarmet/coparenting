                  ...
                  <div className="text">
                        <Accordion id={"fifty-fifty-info"} className="form-accordion" expanded={expandFiftyFiftyInfoText}>
                              ...
                              <AccordionDetails className={"description"}>
                                    ...
                                    <p>
                                          For the start of the next visitation period (and next period ONLY) you have your children, enter the date
                                          ranges for both the first half of the 50/50 and the second half of the 50/50.
                                    </p>
                                    <Spacer height={5} />
                                    <p>
                                    ...
                                    <Spacer height={5} />
                                    <p>
                                          <b>Example</b> <br /> If you have your children (in August) Wednesday-Friday and then Monday-Wednesday
