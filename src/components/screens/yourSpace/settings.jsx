...
export default function Settings() {
    ...
    return (
        <div id="settings-container" className={`${currentUser?.settings?.theme}`}>
            {/* CALENDAR SETTINGS */}
            <Label text={'Calendar'} classes="light always-show" />
            <div
                ...
                <Label text={'Morning Summary Time'} classes={`light smaller always-show ${theme}`} />
                ...
                {/* EVENING SUMMARY */}
                <Label text={'Evening Summary Time'} classes={`smaller light always-show ${theme}`} />
                <InputField
