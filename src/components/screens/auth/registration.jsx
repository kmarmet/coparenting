                  ...
                  if (enteredCode === verificationCode) {
                        ...
                        if (existingParentAccount) {
                              ...
                              if (!Manager.IsValid(existingChild)) {
                                    ...
                                    const updatedSharedDataUsers = DatasetManager.AddToArray(
                                          existingParentAccount?.sharedDataUsers,
                                          currentUserToUse?.key
                                    )
                  ...
                  <div id="registration-container" className="">
                        ...
                        {activeStep === Steps.RequestParentAccess && (
                              <>
                                    ...
                                    <Spacer height={5} />
                                    <p>
                                          When you enter your parent&#39;s phone number and {DomManager.tapOrClick()} the <b>Request Access</b>{" "}
                                          button, a text message containing the code will be sent to them.
                                    </p>
                                    <Spacer height={5} />
                                    ...
                                    <div id="onboarding">
                                          <div className={onboardingScreen === 1 ? "active screen" : "screen"}>
                                                ...
                                                <div className="text-content">
                                                      ...
                                                      {accountType === "parent" && (
                                                            <p className="text">
                                                                  Now you can dive into the world of peaceful co-parenting. You’ll be able to share
                                                                  important details such as expenses and visitation schedules with your co-parent(s).
                                                            </p>
                                                      )}
                                                      {accountType === "child" && (
                                                            <p className="text">
                                                                  Now you can dive in and share important details between you and your parent(s)
                                                            </p>
                                                      )}
                                                      <Spacer height={5} />
                                                      {accountType === "parent" && (
                                                            <p className="text">
                                                                  If you have kids who use the app, you can share calendar events and other essential
                                          ...
                                          <div className={onboardingScreen === 2 ? "active screen" : "screen"}>
                                                ...
                                                <div className="text-content">
                                                      ...
                                                      <Spacer height={5} />
                                                      <p className="text">
                                                            In order to share with a {accountType === "parent" ? "co-parent" : "child"}, you will need
                                                      ...
                                                      <div className="steps">
                                                            <ol>
                                                                  <li>
                                                                        Tap the{" "}
                                                                        <b>{accountType === "parent" ? "Co-Parents or Children" : "Parents"}</b> menu
                                                                        option
                                                                  </li>
                                                                  <li>
                                                                  ...
                                                                  <li>
                                                                        Tap the{" "}
                                                                        <b>Add {accountType === "parent" ? "Co-Parent or Child" : "Parent"}</b> option
                                                                  </li>
                                                            </ol>
                                                      </div>
                                                      <Spacer height={5} />
