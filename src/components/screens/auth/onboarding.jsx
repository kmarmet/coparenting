            ...
            <div id="onboarding">
                  <div className={screen === 1 ? "active screen" : "screen"}>
                        ...
                        <div className="text-content">
                              ...
                              {accountType === "parent" && (
                                    <p className="text">
                                          Now you can dive into the world of peaceful co-parenting. You’ll be able to share important details such as
                                          expenses and visitation schedules with your co-parent(s).
                                    </p>
                              )}
                              {accountType === "child" && (
