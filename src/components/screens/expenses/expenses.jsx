...
export default function Expenses() {
    ...
    const Update = async () => {
        ...
        setState({...state, bannerMessage: "Expense Updated"})
    }
    ...
    const SendReminder = async (expense) => {
        ...
        setState({...state, bannerMessage: "Reminder Sent"})
        setShowDetails(false)
    }
                                        ...
                                        <div className="expenses content" data-expense-id={expense?.id}>
                                            ...
                                            <div className="content-columns">
                                                ...
                                                <div className={"right"}>
                                                    ...
                                                    <p className={`due-date${isPastDue ? " past-due" : ""}${dueInADay || dueInHours ? " soon" : ""}`}>
                                                        Due: {dueDate}
                                                    </p>
