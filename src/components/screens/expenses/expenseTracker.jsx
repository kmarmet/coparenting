               ...
               {view === 'details' && (
                  <>
                     ...
                     <div className="flex">
                        ...
                        <span>
                           {StringManager.getFirstNameOnly(currentUser?.coparents?.filter((x) => x?.key === activeExpense?.payer?.key)[0]?.name)}
                        </span>
                     </div>
                     ...
                     {activeExpense?.dueDate && activeExpense?.dueDate?.length > 0 && (
                        <div className="flex">
                           ...
                           <span>
                              {DateManager.formatDate(activeExpense?.dueDate)} (
                  ...
                  <>
                     ...
                     {DomManager.isMobile() && (
                        <InputWrapper
                           ...
                           labelText={'Due date'}
                           inputType={'date'}
                           defaultValue={moment(activeExpense?.dueDate).format("YYYY-MM-DD")}
                           required={true}
                        />
                     )}
         ...
         <div id="expense-tracker" className={`${theme} page-container form`}>
            ...
            <Fade direction={'up'} duration={1000} triggerOnce={true} className={'expense-tracker-fade-wrapper'}>
               ...
               <p className={`${theme} text-screen-intro`}>
                  Incorporate expenses that your co-parent is responsible for. Should a new expense arise that requires your payment, you will have
                  the option to either approve or decline it.
               </p>
               <Spacer height={8} />
               ...
               <div id="expenses-container">
                  {Manager.isValid(expenses) &&
                     expenses.map((expense) => {
                       ...
                       const isSoon = readableDueDate.toString().includes('in a day')
                           ...
                           <div
                              ...
                              <div id="content" data-expense-id={expense?.id} className={`expense wrap`}>
                                 ...
                                 <div id="name-wrapper" className="flex align-center">
                                   ...
                                   {isSoon &&
                                     <span className={`${expense?.paidStatus} status soon`} id="request-status">
                                       Soon
                                    </span>
                                   }
                                 </div>
