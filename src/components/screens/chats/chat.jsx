                                                ...
                                                <button
                                                      ...
                                                      onClick={() => {
                                                            navigator.clipboard.writeText(
                                                                  Manager.IsValid(activeMessage) ? activeMessage?.message : ""
                                                            )
                                                ...
                                                <div id="right-side" className="flex">
                                                      ...
                                                      {bookmarkedMessagesToIterate.length > 0 && (
                                                            <BsFillBookmarksFill
                                                                  ...
                                                                  className={
                                                                        showBookmarks
                                                                              ? "material-icons  top-bar-icon" + " active"
                                                                              : "material-icons  top-bar-icon"
                                                                  }
                                                ...
                                                {bookmarkedMessagesToIterate.map((bookmark, index) => {
                                                      ...
                                                      return (
                                                            <div {...bind()} key={bookmark?.id} className={"message-wrapper bookmark-message"}>
                                                                        ...
                                                                        <div className="long-press-menu">
                                                                              <button
                                                                                    ...
                                                                                    onClick={(e) => {
                                                                                          ...
                                                                                          const parentNode = e.currentTarget.parentNode
                                                                                          const message =
                                                                                                parentNode.parentNode.querySelector(".message")
                                                                  ...
                                                                  <span
                                                                        className={
                                                                              bookmark?.sender?.key === currentUser?.key
                                                                                    ? "timestamp from"
                                                                                    : "to timestamp"
                                                                        }>
                                                                        From {sender} on&nbsp;{" "}
                                                                        {moment(bookmark.timestamp, "MM/DD/yyyy hh:mma").format(
                                                                              "ddd, MMM DD (hh:mma)"
                                                                        )}
                                                                  </span>
                                                            </div>
                                          ...
                                          <>
                                                ...
                                                <div id="emotion-and-input-field">
                                                      ...
                                                      <div
                                                            ...
                                                            <span className="tone">
                                                                  {StringManager.UppercaseFirstLetterOfAllWords(toneObject?.tone)}
                                                            </span>
                                                      </div>
