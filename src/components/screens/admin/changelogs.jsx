...
const Changelogs = () => {
      ...
      return (
            <>
                  <div id={"changelogs-wrapper"} style={{backgroundImage: `url(${AppImages.changelog.cardBackground.url}`}}>
                        <div className={"content"}>
                              <div className="screen-description">
                                    <h1>Latest Updates </h1>
                                    <p>
                                          Authenticity and transparency are our core values. Because we are committed to keeping you informed about
                                          our progress, we have created this page to share updates.
                                    </p>
                                    <Spacer height={5} />
                                    <p>
                                          We will continuously highlight updates, whether we are adding a new feature or ✨ or fiercely squashing bugs
                                          🪲.
                                    </p>
                              </div>
                              <div className={"cards"}>
                                          ...
                                          changelogs.map((changelog, index) => {
                                                ...
                                                return (
                                                      <div className={"card"} key={index}>
                                                            ...
                                                            <div id="html-wrapper">
                                                                  <HtmlOutput htmlString={changelog?.html} />
                                                            </div>
                                                      </div>
                                                )
                                          })}
