...
export default function AdminDashboard() {
    ...
    const bind = useLongPress((element) => {
        ...
        setState({...state, bannerMessage: "Copied to clipboard"})
    })
    ...
    const SetHolidays = async () => {
        ...
        setState({...state, bannerMessage: "Holidays set"})
    }
    ...
    const GetTextBeltCount = async () => {
        ...
        console.log(balance)
        setState({...state, bannerMessage: balance})
    }
    ...
    const UpdateAppVersion = async () => {
        if (Manager.IsValid(appUpdates)) {
            ...
            setState({...state, bannerMessage: `Updated to Version ${newVersion}`})
        } else {
            await DB.Add(
                `${DB.tables.appUpdates}`,
                appUpdates,
                ...
                <div className="tool-box">
                    ...
                    <div className="buttons">
                        <Button
                            ...
                            className="button"
                            onClick={() => {
                                setState({...state, bannerMessage: "Success Alert"})
                            }}
                        />
                    </div>
                </div>
