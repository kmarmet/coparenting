...
export default function VisitationRequests() {
      ...
      const SelectDecision = async (decision) => {
            ...
            setState({
                  ...
                  successAlertMessage: `Decision Sent to ${StringManager.GetFirstNameOnly(recipientName)}`,
            })
      }
                        ...
                        {view?.label === "Details" && (
                              <div className={`content details`}>
                                    ...
                                    <div className="blocks">
                                          ...
                                          <DetailBlock
                                                classes={
                                                      requestTimeRemaining.toString().includes("ago") ||
                                                      requestTimeRemaining.toString().includes("Today")
                                                            ? "red"
                                                            : "green"
                                                }
                                          ...
                                          {/* Start time */}
                                          <DetailBlock
                                                text={activeRequest?.fromHour}
                                                title={"Start Time"}
                                                valueToValidate={activeRequest?.fromHour}
                                          />
