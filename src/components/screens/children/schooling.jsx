...
export default function Schooling({activeChild}) {
    ...
    return (
        <div className="info-section section schooling">
            <Accordion className={`${theme} child-info`} id={"children-schooling"} disabled={!Manager.IsValid(schoolingValues)}>
                <AccordionSummary
                ...
                <AccordionDetails>
                    <div className={`${Manager.IsValid(schoolingValues) ? "section-wrapper" : "hidden"}`}>
                        {Manager.IsValid(schoolingValues) &&
