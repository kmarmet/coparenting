                              ...
                              <div className="content">
                                    <p>
                                          ...
                                          <span className="subtitle">
                                                Store information and provide sharing permissions for a child that has not been added to your profile
                                                yet
                                          </span>
                                    </p>
                                    ...
                                    <div
                                          ...
                                          <div className="content">
                                                ...
                                                <p>
                                                      ...
                                                      <span className="subtitle">
                                                            Add or update a profile picture of{" "}
                                                            {StringManager.GetFirstNameOnly(activeChild?.general?.name)}
                                                      </span>
                                                </p>
                                                <div className="svg-wrapper">
                                    ...
                                    <div
                                          ...
                                          <div className="content">
                                                <p>
                                                      Manage Checklists{" "}
                                                      <span className="subtitle">
                                                            Add or edit checklists for transferring to or from a co-parent&#39;s home
                                                      </span>
                                                </p>
                                                <div className="svg-wrapper">
                                    ...
                                    <div
                                          ...
                                          <div className="content">
                                                <p>
                                                      ...
                                                      <span className="subtitle">
                                                            Remove sharing permissions for {activeChild?.general?.name} along with their stored
                                                            information
                                                      </span>
                                                </p>
                                                <div className="svg-wrapper add-child">
          ...
          moment."
                  ...
                  {!Manager.IsValid(children) && (
                        <p className={"no-data-fallback-text"}>
                              Currently, no children have been added. To share events with your children or to store their information, please Add
                              them here.
                        </p>
                  )}
            </Screen>
