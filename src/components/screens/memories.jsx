                  ...
                  <div id="memories-container" className={`${theme} page-container`}>
                        ...
                        <div className="screen-content">
                              <Accordion className={`${theme} white-bg memories-accordion accordion`} expanded={showDisclaimer}>
                                    ...
                                    <AccordionDetails>
                                          <p>
                                                All images will be automatically and <b>permanently</b> removed 30 days after the date they were
                                                uploaded. You are welcome to download them at any time.
                                          </p>
                                    </AccordionDetails>
                              </Accordion>
