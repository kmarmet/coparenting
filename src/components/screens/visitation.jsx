...
export default function Visitation() {
      ...
      const GetVisitationHolidays = async (currentUser) => {
            ...
            if (Manager.IsValid(calendarEvents)) {
                  userHolidays = calendarEvents.filter(
                        (x) => x.ownerKey === currentUser?.key && x.fromVisitationSchedule === true && x.isHoliday === true
                  )
            }
            return {
            ...
            switch (scheduleType?.value) {
                  ...
                  case ScheduleTypes.everyWeekend:
                        ...
                        AlertManager.confirmAlert(
                              "Are you sure you would like to Add an Every Weekend visitation schedule?",
                              "I'm Sure",
                              true,
                              async () => {
      ...
      return (
            <Screen activeScreen={ScreenNames.visitation} loadingByDefault={true} stopLoadingBool={contentIsReady}>
                  ...
                  <div id="visitation-container" className={`${theme} page-container`}>
                        ...
                        <div className="screen-content">
                              ...
                              {existingScheduleEvents.length > 0 && (
                                    <>
                                          <p>
                                                You currently have a 50/50 visitation schedule added to your calendar. If you would like to modify the
                                                current schedule or switch to another schedule, please delete the current schedule first.
                                          </p>
                              ...
                              {existingScheduleEvents.length === 0 && (
                                    <div className="sections">
                                          ...
                                          <div
                                                ...
                                                {/* VISITATION SCHEDULE */}
                                                <p>
                                                      When you establish a visitation schedule, it will be displayed on the calendar for you and
                                                      anyone you permit to view it.
                                                </p>
                                                <Spacer height={5} />
                  ...
                  {!showEveryOtherWeekendCard && !showCustomWeekendsCard && !showFiftyFiftyCard && (
