...
export default function Parents() {
    ...
    const DeleteCoparent = async () => {
        ...
        setState({...state, bannerMessage: `${activeParent?.name} has been unlinked from your profile`, showScreenActions: false})
        ...
        <>
                        ...
                        <div
                            ...
                            <div className="content">
                                ...
                                <p>
                                    ...
                                    <span className="subtitle">
                                        Remove sharing permissions for {activeParent?.name} along with the information stored about them
                                    </span>
                                </p>
                            </div>
                        </div>
            ...
            <Form
                ...
                onSubmit={() => {
                    ...
                    setState({...state, bannerMessage: `Invitation has been sent to ${invitedParentName}`})
