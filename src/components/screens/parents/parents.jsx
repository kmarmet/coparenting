...
export default function Parents() {
      ...
      const Update = async (prop, value) => {
            const parentIndex = DB.GetIndexById(parents, activeParent?.id)
      ...
      return (
            <>
                              ...
                              <div className="content">
                                    ...
                                    <p>
                                          ...
                                          <span className="subtitle">
                                                Store information and provide sharing permissions for a parent who that has not been added to your
                                                profile yet
                                          </span>
                                    </p>
                              </div>
                                    ...
                                    <div
                                          ...
                                          <div className="content">
                                                ...
                                                <p>
                                                      ...
                                                      <span className="subtitle">
                                                            Remove sharing permissions for {activeParent?.name} along with the information stored
                                                            about them
                                                      </span>
                                                </p>
                                          </div>
                        ...
                        <div
                              ...
                              <div className="content">
                                    ...
                                    <p>
                                          ...
                                          <span className="subtitle">Send invitation to a parent you would like to share information with</span>
                                    </p>
                              </div>
                        </div>
                                                      ...
                                                      return (
                                                            <div
                                                                  ...
                                                                  <span className="parent-name">
                                                                        {StringManager.GetFirstNameOnly(parent.name)[0]}
                                                                  </span>
                                                            </div>
                                                      )
                                                })}
                                                                                    ...
                                                                                    <div className="flex input">
                                                                                          <InputField
                                                                                                ...
                                                                                                onChange={(e) => {
                                                                                                      ...
                                                                                                      Update(infoLabel, `${inputValue}`).then(
                                                                                                            (r) => r
                                                                                                      )
                                                                                                }}
                                                                                                inputType={InputTypes.text}
                  ...
                  {/* NO DATA FALLBACK */}
                  {!Manager.IsValid(parents) && <p className={"no-data-fallback-text"}>No Parent Contacts</p>}
