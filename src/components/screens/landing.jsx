            ...
            <div id="below-fold-wrapper">
                <div className="flex boxes section below-fold" data-section={1}>
                    <div className="text-box">
                        ...
                        <p className="text-box-main-text">
                            Easily coordinate visitation, school events, and extracurricular activities with our intuitive scheduling tool. Ensuring
                            both parents stay on the same page without the hassle.
                        </p>
                    </div>
                    ...
                    <div
                        ...
                        <p className="text-box-main-text">
                            Facilitate positive communication with in-app messaging designed to reduce misunderstandings.
                        </p>
                        <Spacer height={10} />
                        <div id="emotion-meter-wrapper">
                            <p>Emotion Meter 😃</p>
                            <p className="description">
                                Effective communication with a foundation of respect is crucial for successful co-parenting. The Emotion Meter plays a
                                vital role in facilitating this essential aspect.
                            </p>
                            <LazyImage
                                onClick={() => setShowEmotionMeterSlideshow(true)}
                                imgName={AppImages.landing.emotionMeter.name}
                                alt="Emotion Meter"
                            />
                        </div>
                    </div>
                        ...
                        <div id="feature-grid">
                            ...
                            <div className="feature" onClick={(e) => ToggleFeature(e)} data-name={'any-device'}>
                                ...
                                <p className="feature-subtitle">
                                    Unlike other co-parenting applications that require installation through an app store, which limits them to
                                    specific devices and operating systems (such as Apple and Android), Peaceful Co-Parenting offers a more flexible
                                    solution.
                                </p>
                                <p className="feature-subtitle">
                                    You can install our application on <b>any device</b>—be it a phone, tablet, or computer—and it is compatible with
                                    all operating systems, including Android and Apple.
                                </p>
                                    ...
                                    <div className="feature-details-boxes">
                                        <ul className="parent-ul">
                                            <div className="feature-details-box">
                                                ...
                                                <Spacer height={2} />
                                                <p className="center">
                                                    These steps are provided for Android, iOS (Apple) and Laptop/Desktop computers
                                                </p>
                                            </div>
                                            ...
                                            <div className="feature-details-box">
                                                ...
                                                <p>
                                                    You can install our application on any device, including phones, tablets, and computers, without
                                                    the need for an app store
                                                </p>
                                                <Spacer height={2} />
                                                <p>
                                                    All of your activities and data will be synchronized across all devices if you utilize multiple
                                                    devices
                                                </p>
                                            </div>
                                            <div className="feature-details-box">
                                                ...
                                                <p>
                                                    You can install our application on any device, whether it is a Windows, Mac, Android, or Apple
                                                    device
                                                </p>
                                            </div>
                                            <div className="feature-details-box">
                                                ...
                                                <p>
                                                    All updates, including feature enhancements and bug fixes, are performed automatically in the
                                                    background, requiring no action on your part
                                                </p>
                                                <Spacer height={2} />
                            ...
                            <div className="feature" onClick={(e) => ToggleFeature(e)} data-name={'one-subscription'}>
                                ...
                                <p className="feature-subtitle">
                                    Many co-parenting apps offer various pricing tiers. You receive basic features at one price, but they often upsell
                                    for access to more valuable/useful features. That&#39;s not the case with us!
                                </p>
                                <div className="content">
                                    <div className="feature-details-boxes">
                                        <div className="feature-details-box">
                                            ...
                                            <Spacer height={5} />
                                            <p>
                                                <b>That makes the annual cost $120 for BOTH co-parents instead of $300</b>. You and your co-parent can
                                                take advantage of our application and all its features for less than half the cost of a single
                                                OurFamilyWizard subscription.
                                            </p>
                                        </div>
                                        <div className="feature-details-box">
                                            <p className="box-title">Access to ALL Features - ZERO Upselling</p>
                                            <p>
                                                Too often subscriptions (such as OurFamilyWizard) have several pricing tiers. Basic, Premium, Max,
                                                .etc.
                                            </p>
                                            <ul>
                                            ...
                                            <Spacer height={5} />
                                            <p>
                                                For the price of a cup of coffee ($4.99) you get <b>ALL</b> features because it&#39;s essential for
                                                every co-parent to have access to the full range of resources and tools that our application offers.
                                            </p>
                                            <Spacer height={5} />
                                            <p>
                                                We aim to simplify and bring harmony to your co-parenting experience, which is why we don’t impose
                                                extra fees for accessing essential features.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="feature" onClick={(e) => ToggleFeature(e)} data-name={'ui'}>
                                ...
                                <p className="feature-subtitle">
                                    Numerous applications can often be quite challenging to navigate. Picture this: you need to log an expense to
                                    share with your co-parent, but you&#39;re unable to locate the option to do so.
                                </p>
                                <p className="feature-subtitle">
                                ...
                                <div className="content">
                                    <div className="feature-details-boxes">
                                        <div className="feature-details-box">
                                            ...
                                            <p>
                                                The main menu includes large, clickable menu items that have a name that easily conveys where you will
                                                go when you click it.
                                            </p>
                                            <Spacer height={5} />
                                        ...
                                        <div className="feature-details-box">
                                            ...
                                            <p>
                                                Each page (e.g Expense Tracker, Memories, .etc) features a header text that clearly states its
                                                intended purpose.
                                            </p>
                                            <Spacer height={5} />
                                            <p>
                                                You will find that any potential questions are usually accompanied by supportive text and visual aids
                            ...
                            <div className="feature" onClick={(e) => ToggleFeature(e)} data-name={'realtime'}>
                                ...
                                <p className="feature-subtitle">
                                    You will receive all updates, changes, and notifications <b>instantly</b>, whether the application is open or
                                    closed.
                                </p>
                                <div className="content">
                                    <div className="feature-details-boxes">
                                        <div className="feature-details-box">
                                            ...
                                            <p>
                                                Whenever a co-parent schedules a calendar event, shares a medical record, or sends you a message, you
                                        ...
                                        <div className="feature-details-box">
                                            ...
                                            <p>
                                                If you make an update (add a child, update a calendar event, .etc) you will see the updates{' '}
                                                <b>automatically.</b>
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <div className="content">
                                    <div className="feature-details-boxes">
                                        <div className="feature-details-box">
                                            ...
                                            <p>
                                                You can create multiple co-parent accounts, each with their own unique set of features and
                                                permissions. This allows you to
                                            </p>
                                        </div>
                                        <div className="feature-details-box">
                                            <p className="box-title">Multiple Co-Parents</p>
                                            <p>
                                                Add as many co-parents as you need to and easily utilize all of our application&#39;s features for
                                                each co-parent.
                                            </p>
                                            <Spacer height={5} />

                                            <p>
                                                You have the option to share important information either with individual co-parents or with all of
                                                them simultaneously.
                                            </p>
                                        </div>
                                        <div className="feature-details-box">
                                            ...
                                            <p>
                                                You have the capability to include an unlimited number of children for the purpose of storing
                                                information or sharing updates.
                                            </p>
                                            <Spacer height={5} />
                                            <p>
                                                Any child (with a valid phone number) can create an account and also use our application and access
                                                features such as the calendar, ensuring they stay informed.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="feature" onClick={(e) => ToggleFeature(e)} data-name={'messaging'}>
                                ...
                                <p className="feature-subtitle">
                                    Other applications might offer messaging capabilities, but they lack these specific features
                                </p>
                                <div className="content">
                                    <div className="feature-details-boxes">
                                        <div className="feature-details-box">
                                            ...
                                            <p>
                                                You can pause a conversation and its notifications at any moment, and later resume it whenever you
                                                choose.
                                            </p>
                                        </div>
                                        <div className="feature-details-box">
                                            ...
                                            <p>
                                                Enter more than three characters to view all messages sent or received, including the specific text
                                                you are looking for.
                                            </p>
                                        </div>
                                        <div className="feature-details-box">
                            ...
                            <div className="feature" onClick={(e) => ToggleFeature(e)} data-name={'support'}>
                                ...
                                <p className="feature-subtitle">
                                    It&#39;s frustrating when you contact customer support and have to wait days for a response, only to receive a
                                    generic answer that feels like it was sent to countless others.
                                </p>
                                ...
                                <div className="content">
                                    <div className="feature-details-boxes">
                                        ...
                                        <div className="feature-details-box">
                                            ...
                                            <p>
                                                When you reach out to us for support, your request/concern will go <b>directly</b> to the
                                                technical/development team that will be working on handling the issue, which will eliminate any
                                                unnecessary wait time for your concern/request.
                                            </p>
                                        </div>
                                        <div className="feature-details-box">
                                            <p className="box-title">Feature Requests</p>
                                            <p>
                                                If you would like to have a feature added to our app, let us know! We are more than happy to consider{' '}
                                                <b>all</b> feature requests.
                                            </p>
                                            <Spacer height={5} />
                    ...
                    <div id="documents" className="section text-box documents">
                        <div className="flex text-columns">
                            <div className="text-wrapper left">
                                ...
                                <p className="text">
                                    Co-parents often need to refer back to their separation agreements or other important documents to clarify
                                    specific details, such as holiday visitation arrangements or obligations.
                                </p>
                                <p className="text">
                                    Finding the document is just the first step; after that, you need to sift through it to locate the specific
                                    information you need. This can often be a lengthy and exasperating task.
                                </p>
                            ...
                            <div className="right">
                                ...
                                <Spacer height={5} />
                                <p>
                                    A table of contents is generated for you, allowing quick navigation to any section, utilizing both predefined
                                    headers and your own custom headers.
                                </p>
                                <Spacer height={5} />
                        ...
                        <LazyImage
                            onClick={() => setShowDocumentsSlideshow(true)}
                            imgName={AppImages.landing.tableOfContents.name}
                            alt="Table of Contents"
                        />
                        <Spacer height={8} />
                    </div>
                ...
                <div id="expenses-wrapper" className="section expenses">
                    <div className="text-wrapper">
                        ...
                        <p className="text">
                            Manage shared expenses like childcare, education, and extracurricular costs with our expense tracking feature, making it
                            easy to split costs and avoid conflicts over money.
                        </p>
                    </div>
                ...
                <div>
                    <div id="collaboration" className="section text-box">
                        ...
                        <div className="text-wrapper">
                            ...
                            <p className="text">
                                From medical appointments to school choices, collaborate effectively through our platform’s decision-making tools,
                                keeping your child’s best interests at the forefront.
                            </p>
                            <p className="text">
                                Co-parenting peacefully requires a lot of tools and resources. With that in mind, everything you need can be found in
                                our menu - no time spent looking for anything!
                            </p>
                            <p className="text">
                                Our mission is to provide a supportive space where you and your co-parent can reduce stress and focus on creating a
                                harmonious environment for your children.
                            </p>
                        </div>
                ...
                <div>
                    <div className="box section security-and-privacy with-bg">
                        ...
                        <div className="content text-wrapper">
                            ...
                            <p className="text">
                                <b>Custom Sharing: </b> Keep control over what co-parents see by selecting only the co-parents you want to share with.
                                This includes calendar events, expenses and other important information.
                            </p>
                            <p className="text">
                                <b>Enhanced Protection: </b> Enjoy peace of mind with SMS code verification for password recovery, and secure
                                registration for both parents and children.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    <div className="section text-box all-devices" id="all-devices">
                        ...
                        <div className="text">
                            ...
                            <span>
                                We understand that visual impairments and glare from lighting can be challenging. That&#39;s why our application
                                offers both Light and Dark modes, easily switchable with just a {DomManager.tapOrClick()}. We&#39;re here to ensure
                                your experience is comfortable and accessible!
                            </span>
                        </div>
                    ...
                    <div className="flex" id="double">
                        <div className="text-wrapper text-only box">
                            ...
                            <p className="text">
                                ...
                                functionality, and automatic reminders.
                            </p>
                            <p className="text">
                                <b>Expense Tracker:</b> Stay on top of shared costs by uploading receipts, tracking expenses with live due date
                                countdowns, and sending reminders to the responsible co-parent.
                            </p>
                        </div>
                        <div className="text-wrapper text-only box">
                            <AiTwotoneMessage />
                            ...
                            <p className="text">
                                <b>Easy Messaging: </b> Keep conversations organized with features like message archiving, bookmarking, and a powerful
                                search tool for quick access to important chats.
                            </p>
                            <p className="text">
                                <b>Multimedia Sharing</b> Share memories in real-time by uploading photos and milestones with your co-parent, helping
                                you both stay connected with your child&#39;s journey.
                            </p>
                        </div>
                    </div>
                </div>
