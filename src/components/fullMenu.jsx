        ...
        <div id="full-menu-wrapper" className={menuIsOpen ? 'active' : ''}>
            ...
            {Manager.IsValid(currentUser) && (
                <div ref={scrollRef} id="full-menu-card" {...handlers}>
                    {/* OPTIONS */}
                    <div id="options">
                        <p onClick={() => setActiveSection('sharing')} className={`${activeSection === 'sharing' ? 'active ' : ''}option`}>
                            Sharing
                        </p>
                        <p onClick={() => setActiveSection('contact-info')} className={`${activeSection === 'contact-info' ? 'active ' : ''}option`}>
                            Contact Info
                        </p>
                        <p onClick={() => setActiveSection('co-parenting')} className={`${activeSection === 'co-parenting' ? 'active ' : ''}option`}>
                            Co-Parenting
                        </p>
                    </div>
                    ...
                    <div id="menu-sections">
                        {/* SHARING */}
                        <div className={`section sharing${activeSection === 'sharing' ? ' active' : ''} `}>
                        ...
                        <div className={`section info-storage${activeSection === 'contact-info' ? ' active' : ''}  `}>
                        ...
                        {/* CO-PARENTING */}
                        {currentUser?.accountType === 'parent' && (
                            <div className={`section coparenting${activeSection === 'co-parenting' ? ' active' : ''} `}>
                        ...
                        <FormDivider text={'The Rest'} />
                        {/* PROFILE SETTINGS & SUPPORT */}
                        <div className={`section always-show`}>
                        ...
                        <div id="feedback-wrapper">
                            <p id="feedback-title">
                                Your feedback matters! <br /> How’s your experience today?
                            </p>
                            <Spacer height={2} />
