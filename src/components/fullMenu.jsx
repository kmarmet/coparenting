                              ...
                              <div id="menu-sections">
                                    ...
                                    <div id="feedback-wrapper">
                                          ...
                                          <p id="feedback-subtitle" className={"subtitle in-form"}>
                                                {DomManager.tapOrClick(true)} an emoji to convey how you feel at the moment. Feel free to do this as
                                                often as you wish; the figures show the overall feedback you've provided since you began using our
                                                app.
                                          </p>
                                    ...
                                    <div
                                          id="action-wrapper"
                                          onClick={() =>
                                                setState({...state, currentScreen: ScreenNames.makeItYours, menuIsOpen: false, showOverlay: false})
                                          }>
                                          <p id="report-bug">
