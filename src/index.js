                        ...
                        <div className="active error-boundary" id="error-screen">
                            ...
                            <div id="text-container">
                                ...
                                <div className="flex" id="steps wrap">
                                    <p>
                                        From the <span className="emphasize">Home Screen</span>, swipe up from the bottom of the screen, find our app
                                        and then swipe up to force close it
                                    </p>
                                </div>
                            </div>
