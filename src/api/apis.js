...
Apis = {
    ...
    OneSignal: {
        SendUpdate: function (subId, raw) {
            ...
            myHeaders.append(
                "Authorization",
                "Basic os_v2_app_wjb2emrqojh2re4vwfdvavgfggjfwsj5jpyek6nc65va7p3h3rqusp4v5z5ndqq2bmbu7mdak6ujm4fq5jaxenkk7djvzqxy6rgg7ca"
            )
            requestOptions = {
                method: "POST",
                headers: myHeaders,
            ...
            return fetch("https://api.onesignal.com/notifications?c=push", requestOptions)
